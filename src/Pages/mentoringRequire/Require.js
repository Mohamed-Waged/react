...
import { FaPlusSquare , FaLocationArrow, FaToolbox, FaDollarSign, FaRegClock} from 'react-icons/fa';

const Require = () => {
    const obj = {
        name : "Khadija Saif" ,
        desc :"Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur molestias, voluptatibus eos eveniet mollitia omnis. Odit aliquid sit quo ad voluptas sum dolorsit amet consectetur adipisicing elit. Consequuntur molestias.",
        experience :"None",
        location : "Remote",
        paid : "200sdg/ H",
        duration : "3 month ",
    ...
    return (
        ...
        <div className='container-fluid row d-flex bg-transparent '>
            ...
            <div className="container my-3 col-lg-9">
                <div className="row">
                    <h4 className="title p-2 col-sm-12 col-md-5 col-lg-3 ms-auto me-md-1 text-center text-md-end" id="p1">
                        Mentoring Require
                    </h4>
                </div>
                <div className="row p-3 sec-row">
                    <h4>Front End developer</h4>
                    <h4 ><span id="belal" className='fw-bold' >{obj.name}</span>  is looking for a mentor   </h4> 
                    <p className="desc my-3">{obj.desc}</p>
                </div>
                <div className="row d-flex gap-2">
                    <div id="div1" className="col-5 d-flex align-items-center my-md-2 ">
                        <div><FaDollarSign className='fs-4 me-2'/></div>
                        <div className="align-self-center"><span>Piad :<span id="paid"> {obj.paid}</span></span></div>
                    </div>
                    <div id="div1" className="col-5 d-flex align-items-center my-md-2 ">
                    ...
                    <div id="div1" className="col-5 d-flex align-items-center my-md-2 ">
                        <div ><FaToolbox className='fs-4 me-2'/></div>
                        <div className="align-self-center"><span>Experience :<span id="experience"> {obj.experience} </span></span></div>
                    </div>
                    <div id="div1" className="col-5 d-flex align-items-center my-md-2 ">
                ...
                <div className='row my-3'>
                    <h3 className="tit p-3">I'm looking for help with</h3>
                ...
                <div className='row my-3'>
                    ...
                    <div className="list-1">
                        <ul>
                            <li id="firrequire">{obj.firstresponce}</li>
                ...
                <div className='row my-3'>
                    <h3 className="tit p-3">I have a background about</h3>
                    <div className="list-1">
                        <ul>
                ...
                <div className="profile container p-3 bg-white " >
                    ...
                    <div>
                        <div className="info d-md-flex flex-md-row-reverse align-items-center">
                            ...
                            <div id="ABOUTPER">
                                <h3 className="abuotYou tit d-md-none" id="abuotyou" >About khadija saif</h3>
                            </div>
